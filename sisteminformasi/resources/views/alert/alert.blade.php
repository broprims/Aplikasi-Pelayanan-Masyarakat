        ...
        <div class="">
            <div class="card shadow mb-4">
                <div class="card-body">
                    ...
                    <?php  $notif=Illuminate\Support\Facades\DB::table('surat_permohonan')->limit(1)->where('jenis', '2')->orderby('kode_surat', 'DESC')->get();?>

                    @foreach ($notif as $data)
                    <form action="/alert/alert2/{{ $data->jenis }}" method="POST">
                        @csrf
