...
<body>
	<center>
		<div style="width: 600px; margin-top: 10px; padding-top: 20px; padding-bottom: 20px;">
			<table>
				<tr>
			...
			<table style="margin-top: -10px;">
				...
				<tr class="text2">
					@foreach ($permohonan as $surat)
					<td style="font-size: 18px; text-decoration: underline; text-transform: uppercase;"><b>SURAT KETERANGAN {{$surat->jenis_surat}}</b></td>
					@endforeach
				</tr>
